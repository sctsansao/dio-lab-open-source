...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/user.name`:'git checkout -b feat/community/sctsansao'
    > Exemplo: 'git checkout -b feat/community/sctsansao'
